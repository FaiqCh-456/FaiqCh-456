...
- 🧠 Building **Computer Vision systems** (real-time detection, tracking, and AI pipelines)
...
- 🔍 **Computer Vision Projects**  
  Real-time systems using OpenCV, deep learning, and video streams

- ⚡ **AI Deployment**  
  Turning models into usable APIs and applications

- 🌍 **Full-Stack Apps**  
  Clean UI + strong backend + real-world use cases
